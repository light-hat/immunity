...
<p align="center">
Система интерактивного анализа веб-приложений на Python (Interactive Application Security Testing, IAST), разработанная в рамках моего дипломного проекта. Репозиторий перенёс [отсюда](https://github.com/Immunity-IAST/), чтобы делал статистику на профиле, так что актульная версия содержится здесь.
</p>
